...
/*     */   {
/* 223 */     this(327680);
/* 224 */     if (super.getClass() != MethodNode.class)
...
/* 266 */     if (super.getClass() != MethodNode.class)
...
/*     */   {
/* 416 */     this.instructions.add(
/* 418 */       new FrameNode(type, nLocal, (local == null) ? null : 
/* 417 */       getLabelNodes(local), 
/* 417 */       nStack, (stack == null) ? null : 
...
/*     */   {
/* 497 */     this.instructions.add(
/* 498 */       new TableSwitchInsnNode(min, max, getLabelNode(dflt), 
/* 498 */       getLabelNodes(labels)));
/*     */   }
/*     */ 
/*     */   public void visitLookupSwitchInsn(Label dflt, int[] keys, Label[] labels)
/*     */   {
/* 504 */     this.instructions.add(
/* 505 */       new LookupSwitchInsnNode(getLabelNode(dflt), keys, 
...
/*     */   {
/* 543 */     this.tryCatchBlocks.add(
/* 544 */       new TryCatchBlockNode(getLabelNode(start), 
/* 544 */       getLabelNode(end), 
/* 544 */       getLabelNode(handler), type));
/*     */   }
/*     */ 
...
/*     */   {
/* 572 */     this.localVariables.add(
/* 573 */       new LocalVariableNode(name, desc, signature, 
/* 573 */       getLabelNode(start), 
/* 573 */       getLabelNode(end), index));
/*     */   }
/*     */ 
/*     */   public AnnotationVisitor visitLocalVariableAnnotation(int typeRef, TypePath typePath, Label[] start, Label[] end, int[] index, String desc, boolean visible)
/*     */   {
/* 581 */     LocalVariableAnnotationNode an = new LocalVariableAnnotationNode(typeRef, typePath, 
/* 581 */       getLabelNodes(start), 
/* 581 */       getLabelNodes(end), index, desc);
/*     */ 
/* 583 */     if (visible) {
...
/*     */   {
/* 666 */     if (api == 262144) {
/* 667 */       if ((this.visibleTypeAnnotations != null) && 
/* 668 */         (this.visibleTypeAnnotations
/* 668 */         .size() > 0)) {
/* 669 */         throw new RuntimeException();
/*     */       }
/* 671 */       if ((this.invisibleTypeAnnotations != null) && 
/* 672 */         (this.invisibleTypeAnnotations
/* 672 */         .size() > 0)) {
...
/*     */         }
/*     */       }
/* 704 */       if ((this.visibleLocalVariableAnnotations != null) && 
/* 705 */         (this.visibleLocalVariableAnnotations
/* 705 */         .size() > 0)) {
/* 706 */         throw new RuntimeException();
/*     */       }
/* 708 */       if ((this.invisibleLocalVariableAnnotations == null) || 
/* 709 */         (this.invisibleLocalVariableAnnotations
/* 709 */         .size() <= 0)) return;
...
/*     */   {
/* 740 */     int n = (this.parameters == null) ? 0 : this.parameters.size();
...
/*     */     }
/*     */ 
/* 770 */     n = (this.invisibleTypeAnnotations == null) ? 0 : this.invisibleTypeAnnotations
/* 770 */       .size();
/* 771 */     for (i = 0; i < n; ++i) {
...
/*     */       }
/*     */ 
/* 825 */       n = (this.visibleLocalVariableAnnotations == null) ? 0 : this.visibleLocalVariableAnnotations
/* 825 */         .size();
/* 826 */       for (i = 0; i < n; ++i) {
/* 827 */         ((LocalVariableAnnotationNode)this.visibleLocalVariableAnnotations.get(i)).accept(mv, true);
/*     */       }
/*     */ 
/* 830 */       n = (this.invisibleLocalVariableAnnotations == null) ? 0 : this.invisibleLocalVariableAnnotations
/* 830 */         .size();
/* 831 */       for (i = 0; i < n; ++i) {
 ...
 * Qualified Name:     org.jacoco.agent.rt.internal_8ff85ea.asm.tree.MethodNode
